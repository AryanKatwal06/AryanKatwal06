...
### Languages
<img src="https://skillicons.dev/icons?i=ts,js,java,python,kotlin&theme=dark" />

### Frontend & Mobile
<img src="https://skillicons.dev/icons?i=react,vite,tailwind,html&theme=dark" />
...
| Aspect | Details |
|---|---|
| **Stack** | React Native CLI, TypeScript, Node.js, NestJS, PostgreSQL, Prisma ORM, Firebase, Redis, React Query, Zustand |
...
| Aspect | Details |
|---|---|
| **Stack** | React Native CLI, React 19, TypeScript (strict), Firebase Auth/Firestore/Storage, Cloudinary, React Navigation v7 |
...
| Aspect | Details |
|---|---|
| **Stack** | React Native CLI, TypeScript, Redux Toolkit, React Navigation, SQLite, Axios, Reanimated |
...
- Participating in peer learning sessions on Android architecture and best practices
- Contributing to team-based development workflows
...
- Cross-functional coordination across event domains
- Operational execution for large-scale student events
...
current_focus:
  learning:
    - "Advanced NestJS architecture & microservice patterns"
